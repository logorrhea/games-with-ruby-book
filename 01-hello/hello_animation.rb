...
class GameWindow < Gosu::Window
    ...
    def update
        @explosions.reject!(&:done?) # Removes finished animations from queue
        @explosions.map(&:update)    # Runs update on each explosion
    end
    ...
    def draw
        ...
        @explosions.map(&:draw)   # Runs draw on each explosion
    end
